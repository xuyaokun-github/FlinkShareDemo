 ...
 * desc:
*/
public class HiveQueryDemoTask {

    private final static Logger LOGGER = LoggerFactory.getLogger(HiveQueryDemoTask.class);

    public static void main(String[] args) throws Exception {

        //开始执行
        System.out.println("HiveQueryDemoTask start");
